...
public class TileManager : MonoBehaviour {
	...
	public class Tile
	{
        //creating varables with getters and setters
        ...
        //creating 4 public tiles for each direction
	...
	//creating public list of these tiles
...
0000000000000000000000000000";
        ...
        using (StringReader reader = new StringReader(data))
        {
            ...
            while ((line = reader.ReadLine()) != null)
            {
                ...
                for (int i = 0; i < line.Length; ++i)
                {
                    ...
                    // if the tile we read is a valid movment tile
                    if (line[i] == '1')
                    {
                        // check for left or right adjacent tiles
                        if (i != 0 && line[i - 1] == '1')
                        {
                    ...
                    // if the current tile is not a valid move
                    else newTile.occupied = true;

                    // check for adjacent tiles above and below, starting from second row (Y<30)
	...
	//-----------------------------------------------------------------------
	// Draw lines between neighbor tiles (debug, only shows in editor)
	void DrawNeighbors()
	{
		foreach(Tile tile in tiles)
		{
